...
------ Most important  line number 82-83 ------
...
contract E is C {
   ...
   // by inheriting C we can get info as a variable
   // by creating contract instance we can get info as a function
   function getResult() public view returns(uint) { return result; }
   function getInfoAsVariable() public view returns(uint) { return info; }
   function getInfoAsFunction() public view returns(uint) { return c.info(); }
}
